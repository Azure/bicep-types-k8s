...
### Properties
* **apiVersion**: 'resource.k8s.io/v1alpha2' (ReadOnly, DeployTimeConstant): The api version.
* **kind**: 'PodSchedulingContext' (ReadOnly, DeployTimeConstant): The resource kind.
...
* **kind**: 'ResourceClaimParameters' (ReadOnly, DeployTimeConstant): The resource kind.
* **metadata**: [metadata](#metadata) (Required): The resource metadata.
...
* **kind**: 'ResourceClass' (ReadOnly, DeployTimeConstant): The resource kind.
* **metadata**: [metadata](#metadata) (Required): The resource metadata.
...
* **kind**: 'ResourceClassParameters' (ReadOnly, DeployTimeConstant): The resource kind.
* **metadata**: [metadata](#metadata) (Required): The resource metadata.
